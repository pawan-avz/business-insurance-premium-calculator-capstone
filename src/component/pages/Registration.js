...
const Registration = ()=>{
    ...
    const history = useHistory()
     ...
     //validate function
     const validate = () =>{
        if(!email.includes('@') && password.length<6 && fName.length===0 && lName.length===0){
        ...
        }else if(!email.includes('@') && password.length<6&&lName.length===0){
            setEmailError("Invalid Email Address")
            setPasswordError("Password should be more than 6 characters")
            setlNameError('Last Name should not be Empty')
        }else if(!email.includes('@') && password.length<6&&fName.length===0){
            setEmailError("Invalid Email Address")
            setPasswordError("Password should be more than 6 characters")
            setfNameError('First Name should not be Empty')
    ...
    <div className="register">
        ...
        <span class="registration">You have an account <NavLink to="/login">login</NavLink></span>
        </div>
        </form>
