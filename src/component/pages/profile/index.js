...
function Index({ user }) {
  ...
  const {handleChange,handleSubmit,userProfile}=useForm(setprofile,user,setprofileform)
  return (
    <>
      {profileform ? (
        <>
          ...
          <div className="row">
            <div className="col-md-4 border-right">
              <div className="d-flex flex-column align-items-center text-center p-3 py-5">
                ...
                <span className="text-black-50">{user && user.username}</span>
                <span> </span>
              </div>
            </div>
            ...
            <table className="table table-user-information">
              <tbody>
                ...
                <tr>
                  ...
                  <td className="text-primary">{profile.user && profile.user.firstName} {profile.user && profile.user.lastName}</td>
                </tr>
                <tr>
                  <td>
                    <strong>
                ...
                <tr>
                  ...
                  <td className="text-primary">{profile.user && profile.user.role}</td>
                </tr>
                <tr>
                  <td>
                    <strong>
