...
function Index({ user }) {
  ...
  return (
    <>
      {profileform ? (
        <>
          <div className="container-fluid h-100 bg-376e6f ">
        ...
        <div className="container rounded bg-376e6f  mt-5 mb-5 h-100">
          <div className="row ">
            <div className="col-md-4 border-right">
              <div className="d-flex flex-column align-items-center text-center p-3 py-5">
                <img
            ...
            <div className="col-md-8 border-right">
              <div className="p-3 py-5">
                ...
                <div className="mt-5 ">
                  <button
                    className="btn  text-light profile-button bg-1c3334"
                    type="button"
